...
class InvoiceController extends AppController {
    ...
    public function report(){
        ...
        if (count($this->postData) > 0) {
            ...
            $sCityId = $this->GetPostValue("CityId");
            $invoice = new Invoice();
            if ($sJnsLaporan == 1){
                $reports = $invoice->Load4Reports($this->userCompanyId,$sCabangId,$sGudangId,$sContactsId,$sSalesId,$sStatus,$sPaymentStatus,$sStartDate,$sEndDate,$sEntityId,$sPrincipalId,$sCityId,$sSalesAreaId,$sBrandId,$this->userCabIds);
            }elseif ($sJnsLaporan == 2) {
                $reports = $invoice->Load4ReportsDetail($this->userCompanyId,$sCabangId,$sGudangId,$sContactsId, $sSalesId, $sStatus, $sPaymentStatus, $sStartDate, $sEndDate, $sEntityId,$sPrincipalId,$sCityId,$sSalesAreaId,$sBrandId,$this->userCabIds);
            }elseif ($sJnsLaporan == 3) {
                $reports = $invoice->Load4ReportsRekapItem($this->userCompanyId,$sCabangId,$sGudangId,$sContactsId,$sSalesId,$sStatus,$sPaymentStatus,$sStartDate,$sEndDate, $sEntityId,$sPrincipalId,$sCityId,$sSalesAreaId,$sBrandId,$this->userCabIds);
            }elseif ($sJnsLaporan == 4){
                $reports = $invoice->Load4Reports($this->userCompanyId,$sCabangId,$sGudangId,$sContactsId,$sSalesId,$sStatus,$sPaymentStatus,$sStartDate,$sEndDate,$sEntityId,$sPrincipalId,$sCityId,$sSalesAreaId,$sBrandId,$this->userCabIds);
            }elseif ($sJnsLaporan == 5){
                $reports = $invoice->Load4ReportsRekapItem1($this->userCompanyId,$sCabangId,$sGudangId,$sContactsId,$sSalesId,$sStatus,$sPaymentStatus,$sStartDate,$sEndDate, $sEntityId,$sPrincipalId,$sCityId,$sSalesAreaId,$sBrandId,$this->userCabIds);
            }elseif ($sJnsLaporan == 6){
                $reports = $invoice->LoadSalesOmsetReports($this->userCompanyId,$sCabangId,$sGudangId,$sContactsId,$sSalesId,$sStatus,$sPaymentStatus,$sStartDate,$sEndDate,$sEntityId,$sPrincipalId,$sCityId,$sSalesAreaId,$sBrandId,$this->userCabIds);
            }elseif ($sJnsLaporan == 7){
                $reports = $invoice->LoadOmsetByEntityReports($this->userCompanyId,$sCabangId,$sGudangId,$sSalesId,$sStatus,$sPaymentStatus,$sStartDate,$sEndDate, $sEntityId,$sPrincipalId,$sCityId,$sSalesAreaId,$sBrandId,$this->userCabIds);
            }elseif ($sJnsLaporan == 8){
                $reports = $invoice->LoadOmsetBySalesDetailReports($this->userCompanyId,$sCabangId,$sGudangId,$sSalesId,$sStatus,$sPaymentStatus,$sStartDate,$sEndDate, $sEntityId,$sPrincipalId,$sCityId,$sSalesAreaId,$sBrandId,$this->userCabIds);
            }elseif ($sJnsLaporan == 9){
                $reports = $invoice->LoadOmsetByPrincipleReports($this->userCompanyId,$sCabangId,$sGudangId,$sSalesId,$sStatus,$sPaymentStatus,$sStartDate,$sEndDate, $sEntityId,$sPrincipalId,$sCityId,$sSalesAreaId,$sBrandId,$this->userCabIds);
            }
        }else{
            $sCabangId = 0;
            $sGudangId = 0;
