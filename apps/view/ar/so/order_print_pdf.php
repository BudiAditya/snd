...
$pdf->Cell($pdf->GetPaperWidth(), 5, "SALES ORDER", 0, 0, "C");
$pdf->Ln(7);
$pdf->SetFont("helvetica", "", 10);
$pdf->Cell(20, 5, "Nomor", 0, 0, "L");
$pdf->Cell(4, 5, ":", 0, 0, "L");
//$pdf->SetFont("helvetica", "B", 10);
$pdf->Cell(4, 5, $order->SoNo, 0, 0, "L");
$pdf->SetX(-90,true);
$pdf->SetFont("helvetica", "", 10);
$pdf->Cell(20, 5, "Customer :", 0, 0, "R");
//$pdf->Cell(4, 5, ":", 0, 0, "L");
//$pdf->SetFont("helvetica", "B", 10);
$pdf->Cell(4, 5, $order->CustomerName, 0, 0, "L");
$pdf->Ln(5);
$pdf->SetFont("helvetica", "", 10);
$pdf->Cell(20, 5, "Tanggal", 0, 0, "L");
$pdf->Cell(4, 5, ":", 0, 0, "L");
$pdf->Cell(4, 5, $order->FormatSoDate(JS_DATE), 0, 0, "L");
$pdf->SetX(-90,true);
$pdf->Cell(20, 5, "Alamat :", 0, 0, "R");
//$pdf->Cell(4, 5, ":", 0, 0, "L");
$pdf->Cell(4, 5, $order->CustAddress, 0, 0, "L");
$pdf->Ln(5);
$pdf->Cell(20, 5, "Cabang", 0, 0, "L");
$pdf->Cell(4, 5, ":", 0, 0, "L");
$pdf->Cell(4, 5, $order->CabangCode, 0, 0, "L");
$pdf->SetX(-70,true);
$pdf->Cell(20, 5, $order->CustCity, 0, 0, "L");
$pdf->Ln(2);
$x = 6;
$y = $pdf->GetY();
//garis datar header
