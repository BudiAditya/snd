...
$logo = $cabang->FLogo;
$counter = 0;
$pdf->Image($logo,15,3,15,15);
$pdf->SetLineWidth(0.4);
$pdf->Line(15,20,200,20);
$pdf->SetFont("Tahoma", "B", 14);
$pdf->Cell(20,5,'');
$pdf->Cell(20,5, $cabang->NamaCabang, 0, 0, "L");
$pdf->Ln(8);
$pdf->SetFont("Tahoma", "", 12);
$pdf->Cell(20,5,'');
$pdf->Cell(20, 5, $cabang->Alamat, 0, 0, "L");
$pdf->Ln(10);
$pdf->SetFont("Tahoma", "U", 14);
if($cbtrx->TrxMode == 1){
    $pdf->Cell(180, 5, "K W I T A N S I", 0, 0, "C");
}else{
    $pdf->Cell(180, 5, "BUKTI PEMBAYARAN", 0, 0, "C");
}
$pdf->Ln();
$pdf->SetFont("Tahoma", "", 10);
$pdf->Cell(180, 5, "No. ".$cbtrx->DocNo, 0, 0, "C");
$pdf->Ln(10);
$pdf->SetFont("Tahoma", "", 10);
if($cbtrx->TrxMode == 1){
...
$pdf->Cell(3, 5, ":", 0, 0, "L");
$pdf->Cell(50, 5,'#'.trim(strtoupper(terbilang($cbtrx->TrxAmount))).'#', 0, 0, "L");
$pdf->Ln(10);
...
$pdf->Cell(3, 5, ":", 0, 0, "L");
$pdf->SetFont("Tahoma", "B", 10);
$pdf->Cell(50, 5, 'Rp. '.number_format($cbtrx->TrxAmount,0).',-', 0, 0, "L");
$pdf->Ln(20);
$pdf->SetFont("Tahoma", "", 10);
$pdf->Cell(-60, 5, "(                              )", 0, 0, "L");
$pdf->Ln();
