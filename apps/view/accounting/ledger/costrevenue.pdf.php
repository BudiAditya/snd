...
$pdf->SetHeaderData($company, $monthNames[$month], $year, $parentId, $selectedProject, $statusName);
...
$pdf->Output(sprintf("costrevenue_%d.pdf", $parentId), "D");
