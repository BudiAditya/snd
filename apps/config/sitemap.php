...
$menu = $root->AddNode("PENJUALAN", null, "menu");
    ...
    $menu->AddNode("Transaksi Penjualan", null, "title");
        ...
        //$menu->AddNode("Sales Order (SO)", "ar.so");
    ...
    $menu->AddNode("Laporan Penjualan", null, "title");
        $menu->AddNode("Statistik Penjualan", "ar.dashboard");
        $menu->AddNode("Laporan Sales Order", "ar.order/report");
        $menu->AddNode("Laporan Penjualan", "ar.invoice/report");
        $menu->AddNode("Laporan Penerimaan Piutang", "ar.receipt/report");
        $menu->AddNode("Laporan Retur Penjualan", "ar.arreturn/report");
        //$menu->AddNode("Laporan Profit Penjualan", "report.profit");
        $menu->AddNode("Laporan Rekap Piutang", "ar.mutasi");
...
$menu = $root->AddNode("INVENTORY", null, "menu");
    $menu->AddNode("Master Data", null, "title");
        $menu->AddNode("Daftar Barang", "inventory.items");
        $menu->AddNode("Daftar Harga Barang", "inventory.itemprices");
        $menu->AddNode("Entitas Barang", "inventory.itementity");
        $menu->AddNode("Divisi Barang", "inventory.itemdivision");
        $menu->AddNode("Kategori Barang", "inventory.itemcategory");
        $menu->AddNode("Sub-Kategori Barang", "inventory.itemsubcategory");
        $menu->AddNode("Merk Barang", "inventory.itembrand");
        $menu->AddNode("Satuan Barang", "inventory.itemuom");
...
$menu = $root->AddNode("TVD CASTROL", null, "menu");
    $menu->AddNode("Master Data", null, "title");
        $menu->AddNode("Employee", "tvd.employee");
        $menu->AddNode("Customer", "tvd.customer");
        $menu->AddNode("Warehouse", "tvd.warehouse");
        $menu->AddNode("Product", "tvd.product");
    $menu->AddNode("Transaction", null, "title");
        $menu->AddNode("Invoice", "tvd.invoice");
        $menu->AddNode("Stock", "tvd.stock");
