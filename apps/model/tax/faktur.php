...
class Faktur extends EntityBase {
    ...
    public function LoadAllByMonth($companyId,$tahun,$bulan,$orderBy = "a.nomor_faktur", $includeDeleted = false) {
        $this->connector->CommandText = "SELECT a.* FROM vw_fp_master AS a Where a.company_id = $companyId And a.masa_pajak = $bulan And a.tahun_pajak = $tahun ORDER BY $orderBy";
        $rs = $this->connector->ExecuteQuery();
        return $rs;
    }
