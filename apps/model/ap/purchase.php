...
class Purchase extends EntityBase {
	...
	public function FillProperties(array $row) {
        ...
        $this->JtpDate = $row["jtp_date"];
        $this->AdminName = $row["admin_name"];
        $this->SupInvDate = $row["sup_inv_date"];
	...
	public function Insert() {
        ...
        $this->connector->AddParameter("?sup_inv_date", $this->SupInvDate == 0 || $this->SupInvDate == '' ? null : $this->SupInvDate);
        $this->connector->AddParameter("?jtp_date", $this->JtpDate == 0 || $this->JtpDate == '' ? null : $this->JtpDate);
