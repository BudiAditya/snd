...
class Awal extends EntityBase {
	...
	public function LoadAll($cabangId = 0,$orderBy = "a.cabang_id, a.item_code") {
        $this->connector->CommandText = "SELECT a.* FROM t_ic_saldoawal AS a JOIN m_warehouse b ON a.warehouse_id = b.id Where b.cabang_id = $cabangId ORDER BY $orderBy";
    ...
    public function FindByItemId($cabangId,$itemId) {
        $this->connector->CommandText = "SELECT a.* FROM t_ic_saldoawal AS a WHERE a.cabang_id = ?cabangId And a.item_id = ?itemId";
	...
	public function Insert() {
        $sql = 'INSERT INTO t_ic_saldoawal (trx_no,hpp,warehouse_id,item_id,op_date,op_qty,createby_id,create_time)';
